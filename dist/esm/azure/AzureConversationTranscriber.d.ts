...
export default class AzureConversationTranscriber {
    ...
    options: AzureConversationTranscriberOptions;
    ...
    onRecognitionTextEnd: (text: string, speakerId: string) => void;
    onAudioAnalysis: (dataArray: Float32Array) => void;
    constructor(options?: AzureConversationTranscriberOptions & Partial<EventHandlers>);
...
export {};
//# sourceMappingURL=AzureConversationTranscriber.d.ts.map