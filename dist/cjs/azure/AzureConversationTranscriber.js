...
const loadAndWriteWavToPushStream_js_1 = require("../functions/loadAndWriteWavToPushStream.js");
const downloadAudio_js_1 = require("../functions/downloadAudio.js");
...
class AzureConversationTranscriber {
        ...
        if (this._isRecording && this._recognizer) {
            try {
                if (this.options.debugRecording) {
                    ...
                    (0, downloadAudio_js_1.downloadAudio)(audio48000, 'audio48000.wav');
                    (0, downloadAudio_js_1.downloadAudio)(audio16000, 'audio16000.wav');
                }
    ...
    async loadAndWriteWavToPushStream(url) {
        ...
        if (!this._pushStream)
            return;
        await (0, loadAndWriteWavToPushStream_js_1.loadAndWriteWavToPushStream)(url, this._pushStream);
    }
    async writeWavToPushStream(arrayBuffer) {
        ...
        if (!this._pushStream)
            return;
        (0, loadAndWriteWavToPushStream_js_1.writeWavToPushStream)(arrayBuffer, this._pushStream);
    }
...
exports.default = AzureConversationTranscriber;
/**
 * モノラル化（ステレオ→モノラル）の例
 * すでにモノラルならこの処理は不要。
