...
class AudioAnalysis {
    ...
    static getFrequencies(analyser, sampleRate, fftResult, analysisType = 'frequency', minDecibels = -100, maxDecibels = -30) {
        ...
        if (analysisType === 'music' || analysisType === 'voice') {
            const useFrequencies = analysisType === 'voice' ? constants_js_1.voiceFrequencies : constants_js_1.noteFrequencies;
            ...
            frequencies =
                analysisType === 'voice' ? constants_js_1.voiceFrequencies : constants_js_1.noteFrequencies;
            labels =
                analysisType === 'voice' ? constants_js_1.voiceFrequencyLabels : constants_js_1.noteFrequencyLabels;
        }
        else {
